      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            {/* Live Status Badge */}
            <div className="inline-flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 px-4 py-2 rounded-full text-sm font-semibold w-fit">
            ...
            <p className="text-lg text-slate-300 font-medium leading-relaxed">
              Hola, soy <strong>Alonso Ríos</strong>. Ayudo a personas y negocios a crear sitios web profesionales, recuperar páginas caídas o con fallas, desarrollar aplicaciones Android y aprender programación de forma sencilla.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 py-2">
              <div className="bg-[#121b2d] p-3 rounded-xl border border-[#1e2a42] flex items-center gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-bold text-slate-200">Sitios Web</span>
              </div>
              <div className="bg-[#121b2d] p-3 rounded-xl border border-[#1e2a42] flex items-center gap-2.5">
                <Smartphone className="w-5 h-5 text-indigo-400 shrink-0" />
                <span className="text-xs sm:text-sm font-bold text-slate-200">Apps Android</span>
              </div>
              <div className="bg-[#121b2d] p-3 rounded-xl border border-[#1e2a42] flex items-center gap-2.5">
                <Search className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="text-xs sm:text-sm font-bold text-slate-200">SEO & Arreglos</span>
              </div>
              <div className="bg-[#121b2d] p-3 rounded-xl border border-[#1e2a42] flex items-center gap-2.5">
                <BookOpen className="w-5 h-5 text-amber-400 shrink-0" />
                <span className="text-xs sm:text-sm font-bold text-slate-200">Cursos & Libros</span>
              </div>
            </div>
            ...
            {/* Trust Markers */}
            <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-[#1e2a42] text-sm text-slate-400">
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#121b2d] rounded-3xl p-6 sm:p-8 border border-[#1e2a42] shadow-2xl relative overflow-hidden text-center flex flex-col items-center gap-5">
              ...
              <div className="w-28 h-28 rounded-3xl bg-gradient-to-tr from-blue-600 via-emerald-500 to-amber-400 p-1 shadow-lg relative">
                ...
                <div className="absolute -bottom-2 -right-2 bg-amber-400 text-[#0a1120] p-1.5 rounded-xl font-bold shadow-md">
                  <Award className="w-5 h-5" />
                </div>
              </div>

              <div>
                <h3 className="text-2xl font-bold text-white">Alonso Ríos</h3>
              ...
              <div className="w-full grid grid-cols-2 gap-3 pt-2 text-left">
                <div className="bg-[#0a1120] p-3.5 rounded-2xl border border-[#1e2a42]">
                  ...
                  <div className="text-xs font-semibold text-slate-400">Proyectos Exitosos</div>
                </div>
                <div className="bg-[#0a1120] p-3.5 rounded-2xl border border-[#1e2a42]">
                  <div className="text-2xl font-black text-emerald-400">24 horas</div>
                  <div className="text-xs font-semibold text-slate-400">Respuesta Rápida</div>
                </div>
              </div>
